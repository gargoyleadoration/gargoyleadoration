<img width="1009" height="161" alt="image" src="https://github.com/user-attachments/assets/1caca010-6214-4149-a3cf-d0b3e08d4d18" />

# ${\color{#397c38}"The}$ ${\color{#397c38}dream}$ ${\color{#397c38}will}$ ${\color{#397c38}continue,}$ ${\color{#397c38}repeating}$ ${\color{#397c38}over}$ ${\color{#397c38}and}$ ${\color{#397c38}over."}$
...
# stop telling me i look "grapable" or trying to be weird with me for ONCE. how do i get NORMAL interactions on GENSHIN of all games more than i do on ponytown
...
<details>
 <summary>${\color{#575b66}Gargoyles}$ ${\color{#575b66}VS}$ ${\color{#575b66}Grotesques}$</summary>
  ...
  <img width="200" height="500" alt="image" src="https://github.com/user-attachments/assets/c78d7f20-5ea3-4136-82f0-056f1e8b11ea" /> <img width="200" height="200" alt="image" src="https://github.com/user-attachments/assets/3fdc173e-0566-432e-b453-5b943395ea4f" /> <img width="200" height="200" alt="image" src="https://github.com/user-attachments/assets/a61ab586-52c2-4900-86dd-3e88721f2885" />

These are some examples of grotesques! These are not designed to drain water as there are either no open mouths or no water channel!

<img width="200" height="200" alt="image" src="https://github.com/user-attachments/assets/7c1224fe-81be-4e92-920d-e8aa261766cf" /> <img width="200" height="200" alt="image" src="https://github.com/user-attachments/assets/c2f943a9-9e99-4ce2-b1e2-c7b87294a381" /> <img width="200" height="200" alt="image" src="https://github.com/user-attachments/assets/ed52a743-9cf5-4ef1-a907-a1da3770edb4" />

These are examples of gargoyles! The first one shows the water channel, and thats why they don't have anything on their backs! They always have their mouths open (though in a specific gargoyle's case on the wikipedia, its asshole..)

And now you know how to tell the difference betweena gargoyle and grotesque!!
